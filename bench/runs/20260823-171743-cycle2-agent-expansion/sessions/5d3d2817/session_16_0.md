# session sharegpt_ipLglky_48 — 2023-05-22 (2023/05/22 (Mon) 17:30)

date: 2023/05/22 (Mon) 17:30
iso_date: 2023-05-22

user: Part 34 We conclude that the date of the FOC is not the date on which the building works were completed and from which the statutory warranty period ran.
...
user: Part 36 (3) It is to be presumed (unless an earlier date for practical completion can be established) that practical completion of residential building work occurred on the earliest of whichever of the following dates can be established for the work—

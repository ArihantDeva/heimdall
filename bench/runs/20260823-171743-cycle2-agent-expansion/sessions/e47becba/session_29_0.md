# session sharegpt_T1EiHWI_13 — 2023-05-26 (2023/05/26 (Fri) 04:41)

date: 2023/05/26 (Fri) 04:41
iso_date: 2023-05-26

assistant: A Fighter in Dungeons and Dragons 5th edition gains the Action Surge feature at 2nd level. This ability allows the Fighter to take an additional action on their turn, which can be used for attacking, casting a spell, or any other action that can be taken with an action. The Action Surge feature can be used once per short or long rest, making it a valuable resource for Fighters who want to maximize their effectiveness in combat.

user: how do you calculate a sorcerors spell save dc

assistant: To calculate a Sorcerer's spell save DC (Difficulty Class), you use the following formula:
...
assistant: For a Sorcerer/Monk, there are a few spells that can help increase AC (Armor Class) and improve survivability in combat:
...
assistant: A Monk's Armor Class (AC) is calculated using the following formula:
...
assistant: There are several Sorcerer spells available at 5th level that can enhance a Monk's damage output, either by granting them additional attacks, increasing the damage of their attacks, or adding elemental damage to their attacks. Here are some of the best options:
...
assistant: A 5th level Sorcerer can cast the 2nd level Druid spell Flame Blade by using the Sorcerer's Spellcasting feature to learn the spell.
